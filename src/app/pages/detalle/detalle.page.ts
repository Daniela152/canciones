...
export class DetallePage implements OnInit {
  cancion:any={};
  idCancion:any;
  constructor(public fs:FirestoreService, public r:Router, public ar:ActivatedRoute, public AC:AlertController) { }
  ...
  async eliminarCancion(){
    const Alert=await this.AC.create({message:'Estas seguro de que quieres eliminar la cancion?',buttons:[
      {
